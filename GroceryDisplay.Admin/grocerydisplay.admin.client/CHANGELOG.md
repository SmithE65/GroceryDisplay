...
- Create Angular project with ng: `ng new grocerydisplay.admin.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`grocerydisplay.admin.client.esproj`).
